...
const dictionaries: Record<Locale, Record<string, string>> = {
  fa: {
    ...
    'settings.appearance': 'تنظیمات',
    'settings.privacy': 'حریم خصوصی',
    'settings.chat': 'چت',
    'settings.dataStorage': 'دیتا و فضای ذخیره‌سازی',
    'settings.devices': 'دستگاه‌ها',
    'settings.about': 'درباره',
    'settings.notificationsEnabled': 'فعال اعلان‌ها',
    'settings.notificationSound': 'صدای اعلان',
    'settings.showMessagePreview': 'نمایش پیش‌نمایش پیام',
    'settings.quietHours': 'ساعت آرام',
    'settings.quietHoursDesc': 'در ساعات انتخابی اعلان ندارید',
    'settings.startTime': 'زمان شروع',
    'settings.endTime': 'زمان پایان',
    'settings.darkTheme': 'تم تیره',
    'settings.lightTheme': 'تم روشن',
    'settings.autoTheme': 'خودکار',
    'settings.accentColor': 'رنگ اکسنت',
    'settings.fontSize': 'اندازه فونت',
    'settings.small': 'کوچک',
    'settings.medium': 'متوسط',
    'settings.large': 'بزرگ',
    'settings.bubbleStyle': 'استایل حباب‌ها',
    'settings.rounded': 'گرد',
    'settings.sharp': 'تیز',
    'settings.cloud': 'ابری',
    'settings.readReceipts': 'دریافت خوانده شدن',
    'settings.readReceiptsDesc': 'وقتی پیام شما خوانده می‌شود، یک علامت می‌بینید',
    'settings.lastSeen': 'آخرین بازدید',
    'settings.lastSeenEveryone': 'همه',
    'settings.lastSeenContacts': 'تماس‌ها',
    'settings.lastSeenNone': 'هیچ‌کس',
    'settings.screenLock': 'قفل صفحه',
    'settings.screenLockOff': 'خاموش',
    'settings.screenLockBiometric': 'اثر انگشت/چهره‌شناسی',
    'settings.screenLockPin': 'کد PIN',
    'settings.autoDownload': 'دانلود خودکار',
    'settings.autoDownloadWiFi': 'روی WiFi',
    'settings.imageQuality': 'کیفیت تصویر',
    'settings.low': 'پایین',
    'settings.high': 'بالا',
    'settings.enterToSend': 'اینتر برای ارسال',
    'settings.chatBackup': 'پشتیبان‌گیری از چت',
    'settings.chatBackupDesc': 'به‌صورت خودکار پیام‌ها و رسان‌ها را ذخیره کنید',
    'settings.clearCache': 'پاک کردن کش',
    'settings.clearCacheDesc': 'فضای ذخیره‌شده روی این دستگاه را پاک کنید',
    'settings.activeSessions': 'جلسات فعال',
    'settings.sessionInfo': '{device} • {time}',
    'settings.logoutSession': 'خروج از این دستگاه',
    'settings.version': 'نسخه',
    'settings.appName': 'فلفل چت',
    'settings.aboutDesc': 'یک برنامه چت امن و سبک برای افراد',
    'settings.rateApp': 'امتیاز دادن',
  ...
  en: {
    ...
    'settings.showMessagePreview': 'Show message preview',
    'settings.quietHours': 'Quiet hours',
    'settings.quietHoursDesc': 'Do not disturb during selected hours',
    ...
    'settings.readReceiptsDesc': 'See when your messages are read',
    'settings.lastSeen': 'Last seen',
    'settings.lastSeenEveryone': 'Everyone',
    'settings.lastSeenContacts': 'Contacts only',
    'settings.lastSeenNone': 'Nobody',
    'settings.screenLock': 'Screen lock',
    'settings.screenLockOff': 'Off',
    'settings.screenLockBiometric': 'Fingerprint/Face ID',
    'settings.screenLockPin': 'PIN code',
    'settings.autoDownload': 'Auto-download media',
    'settings.autoDownloadWiFi': 'On WiFi',
    'settings.imageQuality': 'Image quality',
    'settings.low': 'Low',
    'settings.high': 'High',
    'settings.enterToSend': 'Enter to send',
    'settings.chatBackup': 'Chat backup',
    'settings.chatBackupDesc': 'Automatically save messages and media',
    'settings.clearCache': 'Clear cache',
    'settings.clearCacheDesc': 'Clear locally stored data on this device',
    'settings.activeSessions': 'Active sessions',
    'settings.sessionInfo': '{device} • {time}',
    'settings.logoutSession': 'Logout from this device',
    'settings.version': 'Version',
    'settings.appName': 'FelFel Chat',
    'settings.aboutDesc': 'A secure and lightweight messaging app',
